...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_universal(
    ...
    RGB_MOD  , RGB_HUI  , RGB_SAI  , RGB_VAI  , SCRL_STI ,                            RGB_M_K  , RGB_M_X  , RGB_M_G  , RGB_M_T  , RGB_M_TW ,
    RGB_RMOD , RGB_HUD  , RGB_SAD  , RGB_VAD  , SCRL_STD ,                            _______  , CPI_D100 , CPI_I100 , _______  , KBC_SAVE ,
