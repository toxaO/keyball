...
| `AML_TGU`  | `Kb 25`         | `0x7e19` | Increase Auto Mouse target layer (0..31, persists with KBC_SAVE) |
| `AML_TGD`  | `Kb 26`         | `0x7e1a` | Decrease Auto Mouse target layer (0..31, persists with KBC_SAVE) |
...
| キーコード  | Remap上での表記 | 値       | 説明                                                                 |
|:------------|:----------------|:---------|:---------------------------------------------------------------------|
| `AML_TO`    | `Kb 15`         | `0x7e0f` | 自動マウスレイヤーの有効/無効を切り替えます                         |
| `AML_I50`   | `Kb 16`         | `0x7e10` | 自動マウスレイヤーのタイムアウトを50ms増やします (最大3000ms)       |
| `AML_D50`   | `Kb 17`         | `0x7e11` | 自動マウスレイヤーのタイムアウトを50ms減らします (最小300ms)        |
| `AML_TGU`   | `Kb 25`         | `0x7e19` | 自動マウス遷移先レイヤー(TG)を+1します (0..31, KBC_SAVEで保存可能) |
| `AML_TGD`   | `Kb 26`         | `0x7e1a` | 自動マウス遷移先レイヤー(TG)を-1します (0..31, KBC_SAVEで保存可能) |

### スワイプ制御
| キーコード | Remap上での表記 | 値       | 説明                                                       |
|:-----------|:----------------|:---------|:-----------------------------------------------------------|
| `SW_RT`    | `Kb 18`         | `0x7e12` | スワイプリセット遅延を調整します(Shiftで短縮)              |
| `SW_ST`    | `Kb 19`         | `0x7e13` | スワイプ閾値を調整します(Shiftで減少)                      |
| `SW_DZ`    | `Kb 20`         | `0x7e14` | スワイプゆらぎ抑制を調整します(Shiftで減少)                |
| `SW_FRZ`   | `Kb 21`         | `0x7e15` | スワイプ時のポインタフリーズを切り替えます                 |
