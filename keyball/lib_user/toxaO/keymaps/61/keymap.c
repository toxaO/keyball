...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_Def] = LAYOUT_universal(
    ...
    MO(_Sym) , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     , KC_RBRC  ,              KC_NUHS, KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_RSFT  ,
    _______  , KC_LCTL  , KC_LALT  , KC_LGUI,LT(_Sym,KC_LNG2),LT(_Cur,KC_SPC),LT(_Scr,KC_LNG1),  KC_BSPC,LT(_Cur,KC_ENT),LT(_Sym,KC_LNG2),KC_RGUI, _______ , KC_RALT  , KC_PSCR
  ),
